"""
    ...
    @version: 1.1.0
    @description:
                This module contains the vfbls function for real-time testing.

    @copyright Copyright (c) Feb. 27, 2022
        All Rights Reserved
...
# ==============================================
# VFBLS real-time detection module for testing
# ==============================================
...
def vfbls_test_realtime(test_x, mem):
    """
    ...
    if mem == 'low':
        data_vfbls = np.load('./src/VFBLS_v110/bls/model/vfbls_mdl_lowMem.npz', allow_pickle=True)
    elif mem == 'high':
        data_vfbls = np.load('./src/VFBLS_v110/bls/model/vfbls_mdl_highMem.npz', allow_pickle=True)
    else:
        print("Please re-enter.")
        exit()

    # ========= load file.npz =========
    num_add_vf = data_vfbls['num_add_vf']
    N1, N2, N3 = data_vfbls['N1'], data_vfbls['N2'], data_vfbls['N3']
    wh, l2, beta, = data_vfbls['wh'], data_vfbls['l2'], data_vfbls['beta']
    feature1, feature2 = data_vfbls['feature1'], data_vfbls['feature2']
    N1_vfbls, N2_vfbls = data_vfbls['N1_vfbls'], data_vfbls['N2_vfbls']
    beta11, beta11_ivf = data_vfbls['beta11'], data_vfbls['beta11_ivf']
    max_list_set, min_list_set = data_vfbls['max_list_set'], data_vfbls['min_list_set']
    max_list_set_ivf, min_list_set_ivf = data_vfbls['max_list_set_ivf'], data_vfbls['min_list_set_ivf']
    # data_vfbls.close()
    ...
    #
    # # ========= np.savez to file.npz =========
    # np.savez('./src/VFBLS_v110/bls/model/vfbls_mdl_highMem.npz', num_add_vf=num_add_vf,
    #          N1=N1, N2=N2, N3=N3,
    #          feature1=feature1, feature2=feature2,
    #          wh=wh, l2=l2, beta=beta,
    #          N1_vfbls=N1_vfbls, N2_vfbls=N2_vfbls,
    #          beta11=beta11, max_list_set=max_list_set, min_list_set=min_list_set,
    #          beta11_ivf=beta11_ivf, max_list_set_ivf=max_list_set_ivf, min_list_set_ivf=min_list_set_ivf)
    ...
    del TT3
    return 0, 0, Testing_time, predicted
