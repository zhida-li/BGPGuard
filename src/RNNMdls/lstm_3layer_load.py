...
def lstm3_load(batch_size, RnnTest_path, Mdl_path): 
    ...
    hidden_size = 32    # hidden size for fc3
    hidden_size2 = 16   # hidden size for fc4
    ...
    # Tensor
    test_data = test_data_x.type(torch.FloatTensor)   # FloatTensor = 32-bit floating
    test_label = test_label_y.type(torch.LongTensor)  # LongTensor = 64-bit integer
    ...
    model_pkl = 'rnn-lstm3-%d' % batch_size
